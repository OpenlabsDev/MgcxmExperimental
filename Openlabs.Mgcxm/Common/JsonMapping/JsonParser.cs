...
public static partial class Json
{
    ...
    internal static object ParseValue(Type type, string json)
    {
        ...
        {
            DateTime result;
            DateTime.TryParse(json.Replace("\"", ""), System.Globalization.CultureInfo.InvariantCulture,
    ...
    static object ParseObject(Type type, string json)
    {
        ...
        {
            nameToField =
                CreateMemberNameDictionary(type.GetFields(BindingFlags.Instance | BindingFlags.Public |
